...
const Login: React.FC = () => {
  return (
    <div className="min-h-screen pt-32 pb-20 flex flex-col items-center justify-center relative overflow-hidden bg-white">
      ...
      {/* Background Texture - Dot Pattern (Same as Hero) */}
        ...
        <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border border-gray-100 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)]">
          ...
          <form className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between ml-1">
                ...
                <a href="#" className="text-xs font-semibold text-brand-orange hover:text-brand-black transition-colors">Forgot password?</a>
              </div>
              <div className="relative">
                <input 
                  type="password" 
          ...
          <div className="mt-8 text-center text-sm">
             <p className="text-gray-500">
               ...
               <Link to="/signup" className="text-brand-orange font-bold hover:text-brand-black transition-colors">
                 Sign up free
               </Link>
             </p>
          </div>
